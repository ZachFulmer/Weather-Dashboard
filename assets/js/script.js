...
{
    var apiUrl = "http://api.openweathermap.org/geo/1.0/direct?q=" + city + "&limit=1&appid=2eb6beb9db14f1d13ccbe17bee16e2a1";
...
{
    var statusApiUrl = "http://openweathermap.org/img/wn/";
    var imgCode = "";
